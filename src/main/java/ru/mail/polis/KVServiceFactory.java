...
import ru.mail.polis.mburmistrov.service.KVServiceImpl;
import ru.mail.polis.mburmistrov.storage.BasicStorage;
...
final class KVServiceFactory {
    ...
    static KVService create(
        ...
        return new KVServiceImpl(port, new BasicStorage(data.getPath()), topology);
    }
